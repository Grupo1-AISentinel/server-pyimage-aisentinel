...
def seed_users():
    ...
    # Datos para enviar al motor
    students_to_seed = [
        StudentModel(
            carnet="2024342", name="Angel Siliezar", image_path="img/students/angel-siliezar.jpg"
        ),
        StudentModel(
            carnet="2024295", name="Isaac Tiguila", image_path="img/students/isaac-tiguila.jpg"
        ),
        StudentModel(
            carnet="2024442", name="Jeferson Yaxon", image_path="img/students/jeferson-yaxon.jpg"
        ),
        StudentModel(
            carnet="2024449", name="Anderson Sosa", image_path="img/students/anderson-sosa.jpg"
        ),
        StudentModel(
            carnet="2024392", name="Wilson Florian", image_path="img/students/wilson-florian.jpg"
        ),
        StudentModel(
            carnet="2021211", name="Angel Lucero", image_path="img/students/angel-lucero.jpg"
        )
    ]
